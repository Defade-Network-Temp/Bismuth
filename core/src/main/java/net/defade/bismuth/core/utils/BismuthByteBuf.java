...
public class BismuthByteBuf {
    private final ByteBuf source;

    public BismuthByteBuf(ByteBuf source) {
        this.source = source;
    }
    ...
    public BismuthByteBuf writeUTF(String string) {
    ...
    public BismuthByteBuf writeGameType(GameType gameType) {
        writeUTF(gameType.getMiniGame());
        writeUTF(gameType.getMiniGameType());
